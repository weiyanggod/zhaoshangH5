                ...
                <div class="body" style="margin-top: 60px">
                  ...
                  <div>
                    ...
                    >
                        ...
                        <div v-for="(item, index) in mainNewsList" :key="index">
                          <div class="itemClass">
                            ...
                            <div class="content">
                              {{
                                '（' +
                                numberConvertToUppercase()(index + 1) +
                                '）' +
                                item.field0003
                              }}
                            </div>
                          ...
                          <el-divider
                            v-if="index !== mainNewsList.length - 1"
                          ></el-divider>
                        </div>
                      </div>
                      <!-- 各主体招商动态 -->
                          ...
                          <div v-for="(item, index) in Subject" :key="index">
                            <div class="itemClass">
                                ...
                                >
                                  <div style="width: 38%">
                                    <div>
                                      ...
                                      <div v-if="item.field0019 != null">
                                        区领导：{{ item.field0019 }}
                                      </div>
                                    </div>
                                  </div>
                                  <div style="width: 62%" class="pl-10">
                                    接洽内容：{{ item.field0009 }}
                                  </div>
                                </div>
                              </div>
                              <div style="text-align: right">
                                <img
                                  src="./assets/icon/本部.png"
                                  class="icon"
                                  v-if="item.field0010 == '1'"
                                />
                                <img
                                  src="./assets/icon/金控.png"
                                  class="icon ml-5"
                                  v-if="item.field0016 == '1'"
                                />
                                <img
                                  src="./assets/icon/北京.png"
                                  class="icon ml-5"
                                  v-if="item.field0013 == '1'"
                                />
                                <img
                                  src="./assets/icon/深圳.png"
                                  class="icon ml-5"
                                  v-if="item.field0012 == '1'"
                                />
                                <img
                                  src="./assets/icon/上海.png"
                                  class="icon ml-5"
                                  v-if="item.field0014 == '1'"
                                />
                                <img
                                  src="./assets/icon/苏州.png"
                                  class="icon ml-5"
                                  v-if="item.field0015 == '1'"
                                />
                                <img
                      ...
                      <div v-if="ContractedProjectsList.length != 0">
                        <div
                          v-for="(item, index) in ContractedProjectsList"
                          :key="index"
                        >
                          <div class="itemClass mb-10">
                            ...
                            <div class="contracted">
                              ...
                              <div
                                class="contracted-content"
                                style="width: 100%"
                              >
                                <div class="contracted-content-title">
                                  签约项目：{{ item.field0005 }}
                                </div>
                                <div class="contracted-content-text">
                                  <div
                                    class="contracted-content-text-left"
                                    style="width: 53%"
                                  >
                                  ...
                                  <div
                                    class="contracted-content-text-right pl-10"
                                  >
                                    签约内容：{{ item.field0011 }}
                                  </div>
                                </div>
                            ...
                            <div class="active">
                              ...
                              <div class="active-content">
                                ...
                                <div class="active-content-text">
                                  <div
                                    class="active-content-text-left"
                                    style="width: 45%"
                                  >
                      ...
                      <div v-if="startedProjectsList.length != 0">
                        <div
                          v-for="(item, index) in startedProjectsList"
                          :key="index"
                        >
                          <div class="itemClass">
                            <div class="title mt-10" v-if="index === 0">
                              ...
                              <div class="active-content-text">
                                ...
                                >
                                  ...
                                  <div>
                                    总&nbsp;&nbsp;投&nbsp;&nbsp;资：{{
                                      item.field0008 +
                                      (item.field0018 ? item.field0018 : '万元')
                                    }}
                                  </div>
                                </div>
                                <div class="active-content-text-right pl-10">
                      ...
                      <div v-if="billionProjectsList.length != 0">
                        <div
                          v-for="(item, index) in billionProjectsList"
                          :key="index"
                        >
                          <div class="itemClass">
                            <div class="title mt-10" v-if="index === 0">
                              ...
                              <div class="active-content-text">
                                ...
                                <div class="active-content-text-right pl-10">
                                  ...
                                  <div>
                                    总投资：{{
                                      item.field0010 +
                                      (item.field0016 ? item.field0016 : '万元')
                                    }}
                                  </div>
                                </div>
                              </div>
                  ...
                  <div class="itemClass">
                    ...
                    >
                      ...
                      >
                        本期各主体“一把手”共接洽项目
                        <span style="color: rgb(80, 178, 255); font-size: 20px">
                          {{ Subject.length }}
                        </span>
                        个：
                      </div>
                      ...
                      <!-- 柱状图(本年累计接洽情况) -->
                      <div
                        class="mt-30 mb-20 fw-700"
                        style="text-align: left"
                        v-if="ContactBarData.length > 0"
                      >
                        本年各主体“一把手”累计接洽情况：
                      </div>
                      <div
                  ...
                  <!-- 表格 -->
                  <div
                    v-for="(item, index) in [SignedData, talkingData]"
                    :key="index"
                  >
...
export default {
  ...
  methods: {
    ...
    async initPage() {
      ...
      // 区主要领导招商动态库
      const { data: mainNewsList } = await getMainNews(
        this.startTime,
        this.endTime,
      )
      this.mainNewsList = mainNewsList.data
      // 本周签约项目
      const { data: ContractedProjectsList } = await getContractedProjects(
        this.startTime,
        this.endTime,
      )
      ...
      // 亿元以上备案项目
      const { data: FilingItemsList } = await getFilingItems(
        this.startTime,
        this.endTime,
      )
      ...
      // 活动
      const { data: ActivityList } = await getActivity(
        this.startTime,
        this.endTime,
      )
      ...
      // 开工项目
      const { data: startedProjectsList } = await getStartedProjects(
        this.startTime,
        this.endTime,
      )
      ...
      // 十亿元以上备案项目
      const { data: billionProjectsList } = await getBillionProjects(
        this.startTime,
        this.endTime,
      )
      ...
      // 接洽饼图数据
      const { data: pieShipContact } = await getTownshipContactPie(
        this.startTime,
        this.endTime,
      )
      ...
      // 表格数据
      const { data: SignedData } = await getSignedData(
        this.startTime,
        dayjs().format('YYYY-MM-DD'),
      )
      const { data: talkingData } = await getTalkingData(
        this.startTime,
        dayjs().format('YYYY-MM-DD'),
      )
